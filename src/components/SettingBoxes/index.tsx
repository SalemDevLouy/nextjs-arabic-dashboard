  ...
  return (
    <>
      <div className="grid grid-cols-5 gap-8">
        <div className="col-span-5 xl:col-span-3 text-right">
              ...
              <form>
                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-2.5 pr-12.5 text-right  pl-4.5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                        type="text"
                        name="phoneNumber"
                        id="phoneNumber"
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="emailAddress"
                      id="emailAddress"
                      placeholder="louafisalem79@gmail.com"
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-5 pr-13 text-right  pl-5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                      name="bio"
                      id="bio"
                      rows={6}
                      placeholder="اكتب وصفا قصيرا عن نفسك"
                    ></textarea>
                  </div>
                </div>
        ...
        <div className="col-span-5 xl:col-span-2">
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            <div className="border-b border-stroke px-7 py-4 dark:border-dark-3 flex justify-end">
              <h3 className="font-medium text-dark dark:text-white">
                صورتك
              </h3>
            </div>

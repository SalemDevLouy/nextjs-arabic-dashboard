  ...
  return (
    <form>
      <div className="mb-4">
        <label
          htmlFor="email"
          className="mb-2.5 block font-medium text-dark dark:text-white text-right"
        >
          البريد الالكتروني
        </label>
        <div className="relative">
          <input
            ...
            name="email"
            className="w-full text-right rounded-lg border border-stroke bg-transparent py-[15px] pl-6 pr-13 font-medium text-dark outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
          />
